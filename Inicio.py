...
with col2:
    ...
    st.markdown('<p>Repositorio: <a href="https://github.com/Mmari00/entregables_de_nuevas_tecnologias" target="_blank" style="color: #0066cc; font-weight: bold; text-decoration: none;">GitHub</a></p>', unsafe_allow_html=True)
